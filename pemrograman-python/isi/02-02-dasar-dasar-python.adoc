...
Bilangan _integer_ (bulat):

[source,python]
.src/02-02/numeric_int.py
----
include::../{sourcedir}/02-02/numeric_int.py[]
----

Bilangan pecahan (_floating point_):

[source,python]
.src/02-02/numeric_float.py
----
include::../{sourcedir}/02-02/numeric_float.py[]
----
...
----
include::../{sourcedir}/02-02/numeric_complex.py[]
----
...
----
include::../{sourcedir}/02-02/numeric_base.py[]
----
